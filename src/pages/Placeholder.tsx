...
export function Support() {
  return <div style={{ display: "flex", alignItems: "center", justifyContent: "center", height: "100%", color: "rgba(255,255,255,0.15)", fontSize: 24, fontWeight: 700, fontFamily: "Inter, sans-serif" }}>SUPPORT — Coming Soon</div>;
}